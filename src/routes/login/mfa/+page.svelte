<script lang="ts">
    ...
    const authorizeMfa = async () => {
        ...
        localStorage.setItem('panelStateData', JSON.stringify({
            ...$panelAuthState,
            sessionState: 'active'
        }));
...
{:else}
    <article class="p-4">
        ...
        <InputText id="otp" minlength={6} label="Enter OTP" description="Please open your authenticator app and enter the OTP you have recieved now!" placeholder="Code" bind:value={inputtedCode} />
