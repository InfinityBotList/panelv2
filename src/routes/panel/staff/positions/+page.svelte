    ...
    {#if openAction}
        <div class="mb-7 border rounded-md p-3">
            {#if openAction == "create"}
                ...
                <InputText id="name" label="Name" bind:value={createPosition.name} placeholder="New name of the position" minlength={1} showErrors={false} />
            ...
            {:else if openAction == "delete"}
                ...
                <p class="text-red-500">Warning: This will delete the position and remove it from all staff members.</p>
                <Select 
                    id="delete-position"
                    label="Position"
