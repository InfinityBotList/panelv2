...
export type PanelQuery = { "Authorize": { version: number, action: AuthorizeAction, } } | { "Hello": { login_token: string, version: number, } } | { "GetUser": { login_token: string, user_id: string, } } | { "BotQueue": { login_token: string, } } | { "ExecuteRpc": { login_token: string, target_type: TargetType, method: RPCMethod, } } | { "GetRpcMethods": { login_token: string, filtered: boolean, } } | { "SearchEntitys": { login_token: string, target_type: TargetType, query: string, } } | { "UploadCdnFileChunk": { login_token: string, chunk: Array<number>, } } | { "ListCdnScopes": { login_token: string, } } | { "GetMainCdnScope": { login_token: string, } } | { "UpdateCdnAsset": { login_token: string, cdn_scope: string, name: string, path: string, action: CdnAssetAction, } } | { "UpdatePartners": { login_token: string, action: PartnerAction, } } | { "UpdateChangelog": { login_token: string, action: ChangelogAction, } } | { "UpdateBlog": { login_token: string, action: BlogAction, } } | { "UpdateStaffPositions": { login_token: string, action: StaffPositionAction, } } | { "UpdateStaffMembers": { login_token: string, action: StaffMemberAction, } } | { "UpdateStaffDisciplinaryType": { login_token: string, action: StaffDisciplinaryTypeAction, } } | { "UpdateVoteCreditTiers": { login_token: string, action: VoteCreditTierAction, } } | { "UpdateBotWhitelist": { login_token: string, action: BotWhitelistAction, } } | { "PopplioStaff": { login_token: string, path: string, method: string, body: string, } };